...
/**
 * Created by v7 on 5/22/2016.
 */
public class Extra  implements AsyncResponse {
    ...
    public void getData() {
        class GetData extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                //loading = ProgressDialog.show(Extra.this, "Fetching Data", "Wait...", false, false);
            }
    ...
    private void updateDuty(final Integer q)
    {
        ...
        PostResponseAsyncTask loginTask = new PostResponseAsyncTask(Extra.this, postData1);
    ...
    private void allot(){
        for (int j = 0; j < y; j++) {
            ...
            { //c2[i]=s2[i];
                ...
                PostResponseAsyncTask loginTask = new PostResponseAsyncTask(Extra.this, postData);
            ...
            //Intent i;
            //i = new Intent(Extra.this, Clerk.class);
            //startActivity(i);
        }
    }
...
//Toast.makeText(this, output, Toast.LENGTH_LONG).show();
        ...
        {
            //Toast.makeText(context, "Couldn't Allot Staff", Toast.LENGTH_LONG).show();
